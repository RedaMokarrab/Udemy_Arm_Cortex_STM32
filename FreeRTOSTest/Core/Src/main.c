...
/* USER CODE BEGIN Header_StartMCAL_Task */
/**
  * @brief  Function implementing the MCAL_Task thread.
...
/* USER CODE BEGIN Header_StartApplicationHigh */
/**
* @brief Function implementing the ApplicationHigh thread.
* @param argument: Not used
* @retval None
*/
...
void StartApplicationHigh(void const * argument)
{
  ...
  /* USER CODE END StartApplicationHigh */
}

/* USER CODE BEGIN Header_StartApplicationlow */
/**
* @brief Function implementing the Application_low thread.
* @param argument: Not used
* @retval None
*/
...
void StartApplicationlow(void const * argument)
{
  ...
  /* USER CODE END StartApplicationlow */
}
